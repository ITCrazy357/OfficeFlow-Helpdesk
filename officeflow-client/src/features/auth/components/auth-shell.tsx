...
export function AuthShell({ title, children }: AuthShellProps) {
  return (
    <main className="grid min-h-[100dvh] place-items-center bg-[#f2f5f4] px-4 py-8">
      <section className="motion-panel grid w-full max-w-5xl overflow-hidden rounded-3xl border border-white/80 bg-white shadow-2xl shadow-zinc-950/10 ring-1 ring-zinc-950/[0.04] lg:grid-cols-[0.86fr_1fr]">
        <div className="relative hidden min-h-[600px] bg-[#111817] p-8 text-white lg:flex lg:flex-col">
          <div className="motion-enter flex items-center gap-3">
          ...
          <div className="motion-enter mt-auto grid gap-4">
        ...
        <div className="motion-enter grid content-center px-5 py-8 sm:px-10 lg:px-12">
          <div className="mb-8">
