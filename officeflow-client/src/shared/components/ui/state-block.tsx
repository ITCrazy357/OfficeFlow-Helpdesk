...
export function LoadingBlock({ title = "Đang tải dữ liệu" }: Partial<StateBlockProps>) {
  return (
    <div className="grid min-h-64 place-items-center rounded-2xl border border-white/70 bg-white/80 p-6 shadow-sm shadow-zinc-950/[0.04] ring-1 ring-zinc-950/[0.03] backdrop-blur">
...
export function ErrorBlock({ title, message, action }: StateBlockProps) {
  return (
    <div className="grid min-h-64 place-items-center rounded-2xl border border-red-200 bg-red-50/80 px-6 text-center shadow-sm shadow-red-950/[0.06] ring-1 ring-red-950/[0.03]">
...
export function EmptyBlock({ title, message, action }: StateBlockProps) {
  return (
    <div className="grid min-h-64 place-items-center rounded-2xl border border-dashed border-zinc-300 bg-white/80 px-6 text-center shadow-sm shadow-zinc-950/[0.04] ring-1 ring-zinc-950/[0.03] backdrop-blur">
      <div className="grid max-w-md gap-3">
